...
class CherryLogo extends LitElement {
  static get properties() {
    return {
      spin: { type: Number, reflect: true },
      spinCount: { type: String },
      stroke: { type: String },
      spinDuration: { type: String },
    }
  }
